...
log = logging.getLogger("accounting_agent.llm.client")
...
class LLMClient:
    ...
    def generate_qna_answer(
        ...
        system = (
            ...
            "QUY TẮC BẮT BUỘC (VI PHẠM = CÂU TRẢ LỜI BỊ LOẠI):\n"
            "1. Luôn trả lời bằng tiếng Việt thuần túy. TUYỆT ĐỐI KHÔNG viết tiếng Anh.\n"
            "2. KHÔNG được chèn suy luận nội bộ: KHÔNG viết 'Better:', 'I think', "
            "'Let\\'s recall', 'Hmm', 'Actually', 'Wait', 'Not sure'.\n"
            "3. KHÔNG trả lời dạng JSON.\n"
            "4. KHÔNG nói 'Xin lỗi, tôi cần thêm thông tin' — luôn trả lời với kiến thức có sẵn.\n"
            "5. KHÔNG liệt kê bước suy luận (step, reasoning, chain-of-thought).\n\n"
            "CẤU TRÚC CÂU TRẢ LỜI BẮT BUỘC:\n"
            "- Giải thích ngắn gọn (1–2 đoạn) về bản chất tài khoản/nghiệp vụ.\n"
            "- Ít nhất 1–2 ví dụ bút toán với cặp Nợ/Có rõ ràng và số tiền bằng VND.\n"
            "- Ít nhất 1 viện dẫn Thông tư (TT200/2014/TT-BTC hoặc TT133/2016/TT-BTC).\n\n"
            "VÍ DỤ MẪU CÂU TRẢ LỜI ĐÚNG:\n"
            "───────────────────────\n"
            "Câu hỏi: So sánh TK 131 và TK 331?\n\n"
            "TK 131 – Phải thu của khách hàng: phản ánh số tiền khách hàng còn nợ doanh nghiệp. "
            "Bản chất là tài khoản có số dư bên Nợ.\n"
            "Bút toán mẫu: Nợ TK 131 / Có TK 511 – ghi nhận doanh thu bán hàng chưa thu tiền, "
            "ví dụ 50.000.000 VND.\n\n"
            "TK 331 – Phải trả cho người bán: phản ánh số tiền doanh nghiệp còn nợ nhà cung cấp. "
            "Bản chất là tài khoản có số dư bên Có.\n"
            "Bút toán mẫu: Nợ TK 152 / Có TK 331 – mua nguyên vật liệu chưa thanh toán, "
            "ví dụ 30.000.000 VND.\n\n"
            "Căn cứ: TT200/2014/TT-BTC, Điều 17-18.\n"
            "───────────────────────\n\n"
            "Câu hỏi: Khấu hao TSCĐ 30 triệu / 3 năm theo đường thẳng?\n\n"
            "Mức khấu hao hàng năm = 30.000.000 ÷ 3 = 10.000.000 VND/năm.\n"
            "Mức khấu hao hàng tháng ≈ 833.333 VND/tháng.\n\n"
            "Bút toán hàng tháng:\n"
            "- Nợ TK 642 (Chi phí QLDN): 833.333 VND\n"
            "- Có TK 214 (Hao mòn TSCĐ): 833.333 VND\n\n"
            "Căn cứ: TT200/2014/TT-BTC (Điều 35) và TT45/2013/TT-BTC.\n"
            "───────────────────────\n\n"
            "HÃY TRẢ LỜI TRỰC TIẾP — KHÔNG SUY LUẬN, KHÔNG TIẾNG ANH."
        )
        user_prompt = (
            f"Câu hỏi: {question}\n\n"
            f"Dữ liệu ngữ cảnh:\n{context_summary}\n\n"
