...
from accounting_agent.common.models import AcctJournalLine, AcctJournalProposal, AcctVoucher
from accounting_agent.common.utils import new_uuid

log = logging.getLogger("accounting_agent.flows.journal")
        ...
        if lines and len(lines) >= 2:
            ...
            if debit_line and credit_line:
                ...
                if _is_real_llm_enabled():
                    try:
                        from accounting_agent.llm.client import get_llm_client
                        llm = get_llm_client()
