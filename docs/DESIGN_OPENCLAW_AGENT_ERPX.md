# Design Doc: OpenClaw Agent ERPX — Nghiệp vụ Kế toán Ngoài Luồng Ghi Sổ

> **Status**: Source of Truth  
> **Last updated**: 2026-02-07  
> **Scope**: `/root/openclaw-agent-erpx` repository ONLY

---

## 1. Overview

OpenClaw Agent hỗ trợ nghiệp vụ kế toán **ngoài luồng ghi sổ** trong hệ thống ERPX.
...
GHCR: `ghcr.io/mapleleaflatte03/openclaw-agent-erpx/<service>:<tag>`
...
Xem `git log --oneline` trên branch `fix/production-ready-openclaw-agent-erpx`.
